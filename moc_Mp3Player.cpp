...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Mp3Player_t, stringdata) + ofs \
...
void Mp3Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Mp3Player::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Mp3Player::spectrumReady)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Mp3Player::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Mp3Player.data,
      qt_meta_data_Mp3Player,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Mp3Player.stringdata))
