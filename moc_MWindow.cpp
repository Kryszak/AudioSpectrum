...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 50, 12)
    ...
    "MWindow\0findFile\0\0play\0pause\0stop\0"
    "finishedPlaying\0drawSpectrum\0"
};
...
void MWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->findFile(); break;
        case 1: _t->play(); break;
        case 2: _t->pause(); break;
        case 3: _t->stop(); break;
        case 4: _t->finishedPlaying(); break;
        case 5: _t->drawSpectrum(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject MWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MWindow.data,
      qt_meta_data_MWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MWindow.stringdata))
